...
function InfoRow({
  ...
  return (
    <View style={styles.infoBlock}>
      ...
      {editable ? (
        <TextInput
          style={[T.input, focusedField === field && T.inputFocused]}
          value={value ?? ''}
          ...
          <View style={styles.body}>
            ...
            <View style={[T.card, { marginTop: normalize(20) }]}>
              ...
              <View style={styles.twoCol}>
                <View style={styles.col}>
                  <InfoRow
                    label="Phone" value={phonenumber} editable={isEditing}
            ...
            <View style={[T.card, { marginTop: normalize(12) }]}>
              ...
              <View style={T.row}>
                ...
                <View>
                  <Text style={T.statValue}>{userData?.ticketsCompleted ?? 0}</Text>
            ...
            >
              {isSaving
                ...
                : <Text style={T.btnPrimaryText}>{isEditing ? 'SAVE CHANGES' : 'EDIT PROFILE'}</Text>
              }
            </TouchableOpacity>
...
const styles = StyleSheet.create({
  scrollContent: { paddingBottom: normalize(120) },
  headerBand: {
  ...
  body: { paddingHorizontal: normalize(16), width: '100%' },
  ...
  displayName:  {
    color: COLORS.text, fontSize: normalize(22),
    fontWeight: '800', letterSpacing: 2, textAlign: 'center',
  },
  roleChip: {
    backgroundColor: COLORS.primaryDark, borderRadius: R.pill,
    paddingVertical: normalize(4), paddingHorizontal: normalize(12),
    marginTop: normalize(8), borderWidth: 1,
    borderColor: COLORS.borderAccent, ...SHADOW.redSm,
  },
  roleChipText: {
    color: COLORS.primaryBright, fontSize: normalize(11),
  ...
  accentBar:   {
    width: 3, height: normalize(18),
    backgroundColor: COLORS.primaryBright,
    borderRadius: 2, marginRight: normalize(8),
  },
  sectionHeadText: {
  ...
  col:    { flex: 1, marginRight: normalize(10) },

  // Info display
  infoBlock: { marginBottom: normalize(12) },
  infoValue: {
    color: COLORS.text, fontSize: normalize(14),
    fontWeight: '600', paddingVertical: normalize(4),
  },
});
